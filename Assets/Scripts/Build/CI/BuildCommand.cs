...
public static class BuildCommand
{
    ...
    private const string KEYSTORE = "deckfense.keystore";
    ...
    private const string CI_COMMIT_SHORT_SHA = "CI_COMMIT_SHORT_SHA";
    ...
    static string GetFixedBuildPath(BuildTarget buildTarget, string buildPath, string buildName)
    {
        ...
        if (buildPath[buildPath.Length - 1] != '/' && buildName[0] != '/')
        {
    ...
    public static void PerformBuild()
    {
        ...
        UnityEngine.Debug.Log(buildName);
        UnityEngine.Debug.Log(buildOptions);
        UnityEngine.Debug.Log(fixedBuildPath);
    ...
    {
        PlayerSettings.Android.keystoreName = "deckfense.keystore";
        PlayerSettings.Android.keyaliasName = "deckfense";
        PlayerSettings.Android.keystorePass = "goblin";
        PlayerSettings.Android.keyaliasPass = "goblin";
        PlayerSettings.Android.useCustomKeystore = true;
        UnityEngine.Debug.Log("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
    }
    ...
    public static void PerformBuild_Android()
    {
        ...
        var buildReport = BuildPipeline.BuildPlayer(GetEnabledScenes(), fixedBuildPath, BuildTarget.Android, BuildOptions.None);
