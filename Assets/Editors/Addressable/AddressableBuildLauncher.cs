...
{
    public class AddressableBuildLauncher
    {
        public static string build_script
            = "Assets/AddressableAssetsData/DataBuilders/BuildScriptPackedMode.asset";
        public static string settings_asset
            = "Assets/AddressableAssetsData/AddressableAssetSettings.asset";
        public static string profile_name = "Local";
        ...
        [MenuItem("Goblin Games/Asset/Build Addressables only")]
        ...
        [MenuItem("Goblin Games/Asset/Build Addressables and Player")]
        ...
        [MenuItem("Goblin Games/Asset/Upload to remote storage")]
        public static void UploadAddressableAssetToRemote()
        {
            Debug.Log($"{AssetSettings.UploaderPath}");
            BatchFileExecutor.Execute(AssetSettings.UploaderPath);
        }

        [MenuItem("Goblin Games/Asset/Build and Upload to remote storage")]
        public static void BuildAndUpload()
        {
            BuildAddressables();
            UploadAddressableAssetToRemote();
        }
    }
}
#endif